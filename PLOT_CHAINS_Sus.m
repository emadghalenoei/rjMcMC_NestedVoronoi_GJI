function PLOT_CHAINS_Sus(Chain,fpath,figname,fignum)
global x_min x_max z_min z_max  Xn Zn sus_salt_min sus_basement_max
...
%     model(model<0)=-1;
    ...
    imagesc(Xn(1,:),Zn(:,1),SusMap);cbar=colorbar; colormap(jet);
